...
# CakePHP state file
# 
# Deploys CakePHP on nginx + mysql
#
...
/home/{{ short_name }}/current/tmp/shared/cache/models:
  file.directory:
    - user: {{ short_name }}
    - group: {{ short_name }}
    - mode: 755
...
/home/{{ short_name }}/current/tmp/shared/cache/persistent:
  file.directory:
    - user: {{ short_name }}
    - group: {{ short_name }}
    - mode: 755
...
/home/{{ short_name }}/current/tmp/shared/cache/views:
  file.directory:
    - user: {{ short_name }}
    - group: {{ short_name }}
    - mode: 755
...
/home/{{ short_name }}/current/tmp/shared/logs:
  file.directory:
    - user: {{ short_name }}
    - group: {{ short_name }}
    - mode: 755
...
/home/{{ short_name }}/current/tmp/shared/sessions:
  file.directory:
    - user: {{ short_name }}
    - group: {{ short_name }}
    - mode: 755
...
/home/{{ short_name }}/current/tmp/shared/tests:
  file.directory:
    - user: {{ short_name }}
    - group: {{ short_name }}
    - mode: 755
...
/home/{{ short_name }}/current/public/app/tmp:
  file:
    - symlink
    - user: {{ short_name }}
    - group: {{ short_name }}
    - target: /home/{{ short_name }}/current/tmp/shared
